...
%%%sensitivity analysis to r
%%%%%
%%%%%%%%
P=100;%%%P is the percentage change of r
...
legend('Community 1, r_j=1.8\times 10^{8}', 'Community 2, r_j=1.8\times 10^{8}', 'Community 3, r_j=1.8\times 10^{8}', 'Community 1, r_j=3.6\times 10^{8}', 'Community 2, r_j=3.6\times 10^{8}', 'Community 3, r_j=3.6\times 10^{8}') 
