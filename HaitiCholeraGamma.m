...
%%%sensitivity analysis to gamma
%%%%%
%%%%%%%%
P=5;%%%P is the percentage change of gamma
...
% legend('Community 1, \gamma_j=1.8\times 10^{10}', 'Community 2, \gamma_j=1.8\times 10^{10}', 'Community 3, \gamma_j=1.8\times 10^{10}', 'Community 1, \gamma_j=9\times 10^{9}', 'Community 2, \gamma_j=9\times 10^{9}', 'Community 3, \gamma_j=9\times 10^{9}') 
% saveas(h, 'sens_r', 'epsc')
